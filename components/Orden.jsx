  ...
  return (
    <div className="border p-10 space-y-5">
      ...
      <div className="md:flex md:items-center md:justify-between my-10">
        ...
        <button className="bg-indigo-600 hover:bg-indigo text-white mt-5 md:mt-0 py-3 px-10 uppercase font-bold rounded-lg" type="button" onClick={completarOrden}>Completar Orden</button>
      </div>
